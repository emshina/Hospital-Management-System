                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="his_doc_view_single_pharm.php?phar_bcode=<?= $row->phar_bcode; ?>" class="badge badge-success">View</a>
                                                    <a href="pk.php?phar_bcode=<?= $row->phar_bcode; ?>" class="badge badge-warning">Update</a>
