                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="pat_sex" required class="form-control">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="pat_idno" class="form-control" placeholder="National ID Number" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" name="pat_phone" placeholder="0791672871" class="form-control" id="inputCity">
                                                </div>
                                                <div class="form-group col-md-4">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label class="col-form-label">Next of Kin Name</label>
                                                    <input type="text" name="pat_nok_name" class="form-control" placeholder="Next of Kin Full Name" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label class="col-form-label">Next of Kin Contact</label>
                                                    <input type="text" name="pat_nok_contact" class="form-control" placeholder="Next of Kin Phone" required>
                                                </div>
                                            </div>
